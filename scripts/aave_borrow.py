...
def main():
    ...
    # borrowable_eth -> borrowable_amount*95%
...
def repay_all(amount, lending_pool, account):
    ...
    repay_tx.wait(1)
    print(
        "You have deposited, borrowed and repayed with Aave, Brownie and Chainlink!!!"
    )


def get_asset_price(price_feed_address):
    dai_eth_price_feed = interface.AggregatorV3Interface(price_feed_address)
    # index [1] refers to the place in the array of latestRoundData function
